...
const browserWorkerSource = path.join(root, "packages/agent-core/workers/browser-worker.mjs");
...
await stageCuaDriver({ download: process.env.CHATDESK_CUA_DRIVER_FETCH === "1" });
